...
import 'package:ecommerece_assignment_project/modules/dashboard_screen/widget/dashboard_home_menu_unstiched_widget.dart';
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        Obx(
          () => _dashboardHomeMenuController.isLoading.value == true
              ...
              : _dashboardHomeMenuController.hasError.value == true
                  ...
                  : _dashboardHomeMenuController.dashboardHomeMenuTopModel ==
                          null
                      ? const Center(
                          child: Text(
        ...
        Obx(
          () => _dashboardHomeMenuController.isMiddleLoading.value == true
              ? const ProgressIndicatorUtils()
              : _dashboardHomeMenuController.hasMiddleError.value == true
                  ? const Center(
                      child:
                          Text('Something went Wrong,Please try again later!'),
                    )
                  : _dashboardHomeMenuController.dashboardHomeMenuMiddleModel ==
                          null
                      ? const Center(
                          child: Text(
                              'Something went Wrong,Please try again later!'),
        ...
        Obx(
          () => _dashboardHomeMenuController.isBottomLoading.value == true
              ? const ProgressIndicatorUtils()
              : _dashboardHomeMenuController.hasBottomError.value == true
                  ? const Center(
                      child:
                          Text('Something went Wrong,Please try again later!'),
                    )
                  : _dashboardHomeMenuController.dashboardHomeMenuBottomModel ==
                          null
                      ? const Center(
                          child: Text(
                              'Something went Wrong,Please try again later!'),
